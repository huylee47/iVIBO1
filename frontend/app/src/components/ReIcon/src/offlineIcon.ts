...
import Checkin from "@iconify-icons/ri/alarm-line";
import Task from "@iconify-icons/ri/task-line";
import Project from "@iconify-icons/ri/projector-line";
...
addIcon("ri:alarm-line", Checkin);
addIcon("ri:task-line", Task);
addIcon("ri:projector-line", Project);
